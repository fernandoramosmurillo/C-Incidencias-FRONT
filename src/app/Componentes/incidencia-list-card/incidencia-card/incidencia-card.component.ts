...
import { IonCard, IonCardHeader, IonCardTitle, IonCardSubtitle, IonCardContent, IonImg, IonIcon, IonAvatar, IonItem, IonLabel, IonThumbnail } from "@ionic/angular/standalone";
...
@Component({
  ...
  imports: [IonLabel, IonItem, IonIcon, IonImg, IonCardContent, IonCardSubtitle, IonCardTitle, IonCardHeader, IonCard, IonAvatar, AvatarButtonComponent, DatePipe, IonThumbnail],
})
